...
function Intro({ introText, email, video }: Props): ReactElement {
	...
	useEffect(() => {
		...
		if (playVideoBtn.current) playVideoBtn.current.onclick = () => mygallery.open();
	}, [video]);
	...
	return (
		<section id="Home" className="intro-section">
				...
				<Grid container spacing={3}>
					<Grid size={{ sm: 12, md: 6 }} className="intro z-2">
						<Grid container>
							...
							<Grid size={12} sx={{ pt: 4, pb: 4 }} className="display-2--description lh-base">
								<Typography
									variant="h6"
									sx={{
										mr: 2,
					...
					<Grid size={{ sm: 12, md: 6 }} className="intro text-end w-sm-100">
						<div className="video-box">
							<img src="images/intro section.svg" alt="video illustration" className="img-fluid" />
							<a
			...
			<svg viewBox="0 0 1440 320" style={{ position: 'relative', top: '5px' }}>
				<path
					fill="#ffffff"
					fillOpacity="1"
